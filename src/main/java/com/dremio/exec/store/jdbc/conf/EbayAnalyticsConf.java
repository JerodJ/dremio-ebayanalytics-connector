...
@SourceType(value = "EbayAnalyticsARP", label = "EbayAnalytics",uiConfig = "ebayanalytics-layout.json")
public class EbayAnalyticsConf extends AbstractArpConf<EbayAnalyticsConf> {
  private static final String ARP_FILENAME = "arp/implementation/ebayanalytics-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.ebayanalytics.EbayAnalyticsDriver";
